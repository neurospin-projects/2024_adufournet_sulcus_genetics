...
/neurospin/dico/data/deep_folding/current/models/Champollion_V1_after_ablation<br/>
...
for region_model in regions_models:
    ...
    print(region)
    print(model)
    base_path = os.path.expanduser(f"~/tmp1/{region}/{model}/white.British.ancestry")
