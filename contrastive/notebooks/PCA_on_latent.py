...
#base_path = '/neurospin/dico/jlaval/Output/CINGULATE_30-50/*/42433_UKB_Right_random_embeddings/full_embeddings.csv'
#base_path = '/neurospin/dico/data/deep_folding/current/models/Champollion_V0/CINGULATE_left/2024-07-16/16-58-04_1/ukb40_random_embeddings/full_embeddings.csv'
base_path = '/neurospin/dico/data/deep_folding/current/models/Champollion_V0/CINGULATE_right/09-52-22_75/ukb40_random_embeddings/full_embeddings.csv'
...
for file in file_paths:
    ...
    if not glob.glob(f'{initial_path}/42433_{var}varpc.csv'):
        ...
        path_to_save=f'{initial_path}/42433_{var}varpc.csv'
